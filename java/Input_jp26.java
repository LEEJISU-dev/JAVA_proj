...
public class Input_jp26 extends BFrame implements ActionListener{
	Date d= new Date();
	...
	private void init() {
		...
		panline.setBorder(new TitledBorder(new EtchedBorder(),"26기 일본어반 출석 등록"));
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("확인")){
			...
			record [i][2] = s;
			record [i][5] = (String)atcb.getSelectedItem();
			dao.input_Jp26(record[i][0], record[i][5], record[i][2]);
			}
