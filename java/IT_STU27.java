...
public class IT_STU27 extends BFrame implements ActionListener{
	Date d = new Date();
	...
	public IT_STU27(ArrayList<it27Bean> list){
		this.setTitle("27기 it 학생 목록");
		this.list = list;
		init();
	}
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("새로고침")){
			...
			list = dao.insertIt_27();
			try {
				if (date.format(d).equals(bean.getDate())) {
					dao.delete_it27(date.format(d));
				}
